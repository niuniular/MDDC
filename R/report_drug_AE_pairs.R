...
#' \item \code{AE} the potential adverse event for the drug.
#' \item \code{observed_num} the observed count of the (drug, AE) pair.
#' \item \code{expected_num} the expected count of the (drug, AE) pair.
