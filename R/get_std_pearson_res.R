...
#'
#' @description Compute the standardized Pearson residuals for a given \eqn{I \times J} contingency table.
#'
#' @usage
...
#'
#' @return A matrix of the standardized Pearson residuals of the input contingency table.
#' @export
#'
#' @examples
